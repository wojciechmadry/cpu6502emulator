...
Memory Memory::clone() const noexcept { return Memory{*this}; }

Memory::Memory(Memory &&mem) noexcept { m_memory = std::move(mem.m_memory); }

Memory::Memory(const Memory &mem) { m_memory = mem.m_memory; }
