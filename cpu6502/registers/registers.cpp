...
void Registers::setRegister(RegistersName regName, std::uint32_t value) noexcept
{
    switch(regName)
    {
        ...
        {
            PS.set(registers::ProcessorStatus::Flags::BreakCommand, static_cast<bool>(value));
            break;
        }
        ...
        {
            PS.set(registers::ProcessorStatus::Flags::CarryFlag, static_cast<bool>(value));
            break;
        }
        case cpu6502::RegistersName::ProcessorStatusDecimalMode:
        {
            PS.set(registers::ProcessorStatus::Flags::DecimalMode, static_cast<bool>(value));
            break;
        }
        case cpu6502::RegistersName::ProcessorStatusInterruptDisable:
        {
            PS.set(registers::ProcessorStatus::Flags::InterruptDisable, static_cast<bool>(value));
            break;
        }
        case cpu6502::RegistersName::ProcessorStatusNegativeFlag:
        {
            PS.set(registers::ProcessorStatus::Flags::NegativeFlag, static_cast<bool>(value));
            break;
        }
        case cpu6502::RegistersName::ProcessorStatusOverflowFlag:
        {
            PS.set(registers::ProcessorStatus::Flags::OverflowFlag, static_cast<bool>(value));
            break;
        }
        case cpu6502::RegistersName::ProcessorStatusZeroFlag:
        {
            PS.set(registers::ProcessorStatus::Flags::ZeroFlag, static_cast<bool>(value));
            break;
        }
