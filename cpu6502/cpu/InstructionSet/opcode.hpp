...
enum class BCC {
  Relative =
      0x90 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BCS {
  Relative =
      0xB0 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BEQ {
  Relative =
      0xF0 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BMI {
  Relative =
      0x30 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BNE {
  Relative =
      0xD0 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BPL {
  Relative =
      0x10 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BVC {
  Relative =
      0x50 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};

enum class BVS {
  Relative =
      0x70 // 2 ( +1 if branch success, +2 if to a new page) - Implemented
};
