...
bool ADDRESSING_RELATIVE_TEST() {
  ...
  // How it works?
  // If branch -> add value to program counter (You need also add 2 because
  // instruction increment program counter twice) You can jump to label (You
  // need define them before)
