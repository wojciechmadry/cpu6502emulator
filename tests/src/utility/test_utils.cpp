...
void load_value_to_reg(cpu6502::CPU &cpu, cpu6502::Byte value,
                       cpu6502::Byte opcode) {
...
void load_to_acu(cpu6502::CPU &cpu, cpu6502::Byte value) {
  load_value_to_reg(
      cpu, value, static_cast<cpu6502::Byte>(cpu6502::opcode::LDA::Immediate));
}

void load_to_xreg(cpu6502::CPU &cpu, cpu6502::Byte value) {
  load_value_to_reg(
      cpu, value, static_cast<cpu6502::Byte>(cpu6502::opcode::LDX::Immediate));
}

void load_to_yreg(cpu6502::CPU &cpu, cpu6502::Byte value) {
  load_value_to_reg(
      cpu, value, static_cast<cpu6502::Byte>(cpu6502::opcode::LDY::Immediate));
}
...
void push_to_stack(cpu6502::CPU &cpu, cpu6502::Byte value) {
  ...
  auto PC = cpu.get_registers().PC.get();
  memory[PC++] =
      static_cast<cpu6502::Byte>(cpu6502::opcode::PHA::Implied); // 3 cycles
  cpu.execute(3);
}
...
cpu6502::Byte pop_from_stack(cpu6502::CPU &cpu) {
  ...
  memroy[PC++] =
      static_cast<cpu6502::Byte>(cpu6502::opcode::PLA::Implied); // 4 cycles
  cpu.execute(4);
