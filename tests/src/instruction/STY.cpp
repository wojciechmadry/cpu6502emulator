...
bool STY_TEST() {
  ...
  mem[0x4242 + 2] =
      static_cast<decltype(opcode)>(cpu6502::opcode::STY::ZeroPage); // 3 cycles
  mem[0x4242 + 3] = 0x42;
  cpu.execute(8);
  ...
  mem[0x4242 + 4] = static_cast<decltype(opcode)>(
      cpu6502::opcode::STY::ZeroPageX); // 4 cycles
  mem[0x4242 + 5] = 0x42;
  cpu.execute(11);
  ...
  mem[0x4242 + 1] = 40; // ACU = 40
  mem[0x4242 + 2] =
      static_cast<decltype(opcode)>(cpu6502::opcode::STY::Absolute); // 4 cycles
  mem[0x4242 + 3] = 0x30;
  mem[0x4242 + 4] = 0x30;
  cpu.execute(9);
