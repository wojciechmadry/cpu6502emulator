...
bool SBC_TEST() {
  ...
  auto turn_on_carry_flag = [&]() {
    ...
    mem[PC++] =
        static_cast<cpu6502::Byte>(cpu6502::opcode::SEC::Implied); // 2 cycles
    cpu.execute(2);
  };
  ...
  opcode = static_cast<decltype(opcode)>(
      cpu6502::opcode::SBC::Immediate); // 2 cycles
  ...
  for (std::uint16_t i = 0; i <= 255; ++i) {
    for (std::uint16_t j = 0; j <= 255; ++j) {
      ...
      // Check carry flag
      all_good &=
          cpu.get_registers().PS.get(PSFlags::CarryFlag) == !(add_res < 0);
  ...
  opcode =
      static_cast<decltype(opcode)>(cpu6502::opcode::SBC::ZeroPage); // 3 Cycles
  turn_on_carry_flag();
  ...
  all_good &=
      cpu.get_registers().ACU.get() == static_cast<cpu6502::Byte>(37 - 40);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(37 - 40 - 0x5);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(37 - 40 - 0x5 - 128);
  ...
  opcode = static_cast<decltype(opcode)>(
      cpu6502::opcode::SBC::ZeroPageX); // 4 Cycles
  turn_on_carry_flag();
  ...
  all_good &=
      cpu.get_registers().ACU.get() == static_cast<cpu6502::Byte>(30 - 40);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(30 - 40 - 0x5);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(30 - 40 - 0x5 - 120);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(30 - 40 - 0x15);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(30 - 40 - 0x15 - 1);
  ...
  all_good &=
      cpu.get_registers().ACU.get() == static_cast<cpu6502::Byte>(15 - 40 - 5);
  ...
  all_good &= cpu.get_registers().ACU.get() ==
              static_cast<cpu6502::Byte>(15 - 40 - 5 - 128);
